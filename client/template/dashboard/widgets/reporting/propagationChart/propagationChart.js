...
Template.propagationChartWidget.onCreated(function() {
...
Template.propagationChartWidget.onRendered(function() {
  var template = this;
...
Template.propagationChartWidget.events({
  'click #ref_propagationChartWidget': function(event, template) {
    clearOldCharts();
...
buildChart = function(template, chartType) {
  var ctx = document.getElementById("propagationChartDisplayArea").getContext("2d");
