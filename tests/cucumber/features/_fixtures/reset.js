export function reset() {
  ...
  const { Activities, Companies, Contacts, CustomFields, Notifications, Projects, Products, PurchaseOrders, PurchaseOrderItems, Opportunities, Tasks } = require('/imports/api/collections.js');
