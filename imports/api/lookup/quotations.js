export const Quotations = {
  quotationOfDay() {
    const date = new Date();
    date.setMonth(0, 0);
    const i = Math.round((new Date() - date) / 8.64e7) % Quotations.quotes.length;
    const quoteObject = Quotations.quotes[i];
  ...
  quotes: [
    {
      ...
      "Quote": "The number one reason people fail in life is because they listen to their friends, family, and neighbours.",
      "Person": "Napoleon Hill"
    }, {
      "Quote": "The reason most people never reach their goals is that they don't define them, or ever seriously consider them as believable or achievable. Winners can tell you where they are going, what they plan to do along the way, and who be sharing the adventure with them.",
      "Person": "Denis Watiley"
    }, {
      "Quote": "Success does not consist in never making mistakes but in never making the same one a second time.",
      "Person": "George ard Shaw"
    }, {
      ...
      "Person": "Margaret Lee Runbeck"
    }, {
      "Quote": "Purpose is what gives life a meaning.",
      "Person": "C. H. Parkhurst"
    }, {
